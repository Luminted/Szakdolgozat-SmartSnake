...
import {squaredEuclideanDistance, EuclideanDistance} from '../customUtils.js';

export default class ClosestPillStrategy extends Strategy{
    ...
    pathfinder(snake) {
        ...
        let heurism = squaredEuclideanDistance;
